      ...
      <article className="px-4 sm:px-7 py-12 sm:py-20">
        <div className="max-w-[1400px] mx-auto">
          <button
            type="button"
            onClick={onBack}
            className="font-utility text-[0.7rem] uppercase tracking-[0.18em] mb-8 inline-flex items-center gap-2 border-b border-[var(--color-accent-code)] text-[var(--color-accent-code)] hover:gap-3 transition-all"
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        {items.length === 0 ? (
          <div className="border border-dashed border-[var(--border-color)] p-12 text-center">
            ...
            <p className="font-utility text-xs uppercase tracking-[0.18em] text-[var(--text-muted)]">
              Add .md files to src/content/collections/{collection.slug}/
            </p>
          </div>
        ) : (
